...
export const MobileStickyBar = ({ onOpenSiteVisit, onOpenEnquiry }) => {
  return (
    <div className="md:hidden fixed bottom-0 left-0 right-0 z-50 bg-obsidian-950/95 backdrop-blur-lg border-t border-white/10 px-4 py-2.5 flex items-center justify-between gap-2 shadow-2xl">
      ...
      <a
        href="https://wa.me/919090104949?text=Hi%2C%20I%20am%20interested%20in%20Rajan%20Castle%20Properties%20Fourth%20City%20and%20Hyderabad%20investments"
        target="_blank"
      ...
      <button
        ...
        className="flex-1 flex items-center justify-center gap-1.5 py-2.5 px-3 rounded-lg bg-gradient-to-r from-gold-500 to-gold-600 text-obsidian-950 font-bold text-xs hover:from-gold-400 hover:to-gold-500 active:scale-95 transition-all shadow"
      >
